...
function buildOperationalPrompt(input: string, messages: Message[] = [], conversation?: Conversation | null, assistantMode: AssistantMode = 'copilot') {
  ...
  return [
    ...
    'NUNCA inventes datos del negocio: no menciones clientes, inmuebles, operaciones, facturas ni tareas como si existieran salvo que consten en el CRM (Supabase) o en el contexto aportado.',
