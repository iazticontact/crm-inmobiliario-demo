...
- DETALLE vs BÚSQUEDA (principio general, aplica a cualquier entidad): si el usuario pide la ficha/el detalle/el 360 de UNA entidad concreta e identificada (por nombre, pronombre u ordinal), usa la capability «.detail» con esa entityRef. Usa «.search»/«.list» solo para LOCALIZAR o enumerar cuando no hay una entidad única identificada. El detalle deja esa entidad como referente para el turno siguiente; la búsqueda no.
