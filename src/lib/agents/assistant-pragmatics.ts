...
const CAPABILITY_SELF = /\b(que puedes hacer|que sabes hacer|que haces|para que sirves|para que vales|cuales son tus (capacidades|limites|funciones)|tus (capacidades|limites)|en que me ayudas|con que me puedes ayudar|que mas puedes)\b/
