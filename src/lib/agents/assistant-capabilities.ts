...
export const ASSISTANT_CAPABILITIES: Capability[] = [
  ...
  { key: 'opportunities', label: 'Operaciones / pipeline', status: 'active', note: 'Veo operaciones por etapa, valor, probabilidad y cierre previsto.' },
  { key: 'service_cases', label: 'Expedientes', status: 'active', note: 'Veo expedientes por estado, prioridad y vencimiento.' },
  { key: 'tasks', label: 'Tareas', status: 'active', note: 'Veo tareas pendientes, vencidas y próximas, y puedo prepararlas para confirmar.' },
  { key: 'calendar', label: 'Calendario interno', status: 'active', note: 'Veo citas de hoy/semana y por cliente; preparo/edito con confirmación.' },
  { key: 'activity', label: 'Actividad', status: 'active', note: 'Veo la actividad reciente y el histórico por cliente.' },
  { key: 'properties', label: 'Propiedades', status: 'active', note: 'Veo la cartera de propiedades.' },
...
export function buildCapabilityBlock(): string {
  ...
  return [
    ...
    '2. ¿Qué entidad? cliente / operación / expediente / tarea / cita / propiedad / documento.',
    ...
    '- Ficha completa → secciones claras: Identificación · Contacto · Situación comercial · Operaciones · Expedientes · Tareas · Calendario · Actividad · Documentos. Campos vacíos = "No consta".',
