...
3. Abrir `/assistant` y señalar: "Mensajes reales", "NowLabs AI backend activo" y "Workspace real".
...
8. Cierre: "La siguiente fase es WhatsApp Business Platform oficial para que estas reservas entren solas desde mensajes reales".
...
- Señalar badges de estado: Supabase conectado, Assistant persistente, NowLabs AI backend activo.
...
- Abrir `/assistant`.
- Confirmar visualmente: "Mensajes reales", "NowLabs AI backend activo", "Workspace real".
...
- Frase comercial: "El siguiente paso es conectar WhatsApp Business Platform oficial para que estas reservas entren desde mensajes reales".

## Demo de 10 minutos

1. Login real y dashboard.
2. Cliente real: crear, editar nota y revisar estado.
3. Assistant: conversación real con NowLabs AI backend.
...
- "La siguiente fase es WhatsApp Business Platform oficial para que los mensajes entren solos".

## Qué no prometer todavía

- WhatsApp Business no está conectado aún.
